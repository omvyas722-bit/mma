...
const leads = [
  ...
  { first_name: 'Mia', last_name: 'Chang', email: 'mia.chang@email.com', phone: '555-0204', source: 'Facebook Ad', stage: 'contacted', interest_level: 'high', location: 'Sydney', assigned_to: S_TOM, notes: 'Signed up for free trial link but hasnt booked her session yet. Works in CBD, evenings only.', follow_up_status: 'in_progress', last_contact_date: '2026-05-27' },
  { first_name: 'Jake', last_name: 'Miller', email: 'jake.m@email.com', phone: '555-0205', source: 'Walk-in', stage: 'trial_booked', interest_level: 'high', location: 'Newtown', assigned_to: S_SARAH, trial_date: '2026-05-31', trial_class_type: 'bjj', trial_coach_id: S_SARAH, notes: 'Walked past, saw sparring through window, came in immediately. Has wrestling background in high school.', follow_up_status: 'pending' },
  { first_name: 'Olivia', last_name: 'Taylor', email: 'olivia.t@email.com', phone: '555-0206', source: 'website', stage: 'trial_booked', interest_level: 'high', location: 'rockingham', assigned_to: S_MIKE, trial_date: '2026-05-31', trial_class_type: 'muay_thai', trial_coach_id: S_MIKE, notes: 'First gym experience ever. Nervous but determined. Wants to learn self-defense after incident at work.', follow_up_status: 'pending' },
  ...
  { first_name: 'Ethan', last_name: 'Harris', email: 'ethan.h@email.com', phone: '555-0209', source: 'Google Ads', stage: 'converted', interest_level: null, location: 'Sydney', converted_member_id: 29, notes: 'Converted to trial membership. Started May 25. Referred by friend who trains at another gym.', follow_up_status: 'completed', last_contact_date: '2026-05-25' },
  { first_name: 'Liam', last_name: 'Roberts', email: 'liam.r@email.com', phone: '555-0210', source: 'Facebook Ad', stage: 'lost', interest_level: 'low', location: 'Parramatta', lost_reason: 'Chose a different gym closer to home', notes: 'Was interested in Muay Thai but found a gym in Parramatta closer to his work.', follow_up_status: 'completed' },
...
const products = [
  ...
  { name: 'MMA Gloves', category: 'gear', sku: 'GL-001', cost_price: 30.00, sell_price: 79.95, stock_quantity: 3, min_stock_level: 5, size: 'S/M/L', brand: 'MMA Gear Pro' },
  { name: 'Shin Guards', category: 'gear', sku: 'SG-001', cost_price: 35.00, sell_price: 89.95, stock_quantity: 8, min_stock_level: 5, size: 'S/M/L', brand: 'MMA Gear Pro' },
...
const staffTasks = [
  ...
  { lead_id: 7, assigned_to: S_TOM, task_type: 'follow_up_trial', priority: 'high', title: 'Follow up with Noah Williams - trial completed', description: 'Noah had trial on 26th. Liked it but concerned about price. Send pricing options and offer first month discount.', due_date: today, status: 'in_progress' },
  ...
  { lead_id: 6, assigned_to: S_MIKE, task_type: 'trial_reminder', priority: 'high', title: 'Confirm Olivia Taylor trial session tomorrow', description: 'Olivia has Muay Thai trial booked 31st with Coach Sarah Connor. First gym experience - call to reassure.', due_date: today, status: 'pending' },
  { lead_id: 8, assigned_to: S_TOM, task_type: 'warm_lead_checkin', priority: 'medium', title: 'Sophie Clark - warm lead check-in', description: 'Sophie completed trial 25th, rated 4/5. Interest shown but concerned about injury. Share injury prevention info.', due_date: tomorrow, status: 'pending' },
  ...
  { lead_id: 11, assigned_to: S_TOM, task_type: 'warm_lead_checkin', priority: 'medium', title: 'Zoe Martin - womens training inquiry', description: 'Zoe (friend of Mike Wilson) asked about womens-only sessions. Share womens class schedule and reassure about no-sparring option.', due_date: tomorrow, status: 'pending' },
...
const scheduledMessages = [
  ...
  { lead_id: 6, message_type: 'sms', status: 'pending', recipient_phone: '555-0206', body: 'Hi Olivia! Excited to have you for your first Muay Thai session tomorrow at 9am with Sarah. Don\'t worry about being new - our beginners class is designed for you! Just bring water. - ROAR MMA 🥊', scheduled_for: `${today} 18:00:00` },
  { lead_id: 7, message_type: 'email', status: 'pending', recipient_email: 'noah.w@email.com', subject: 'Special offer just for you, Noah!', body: 'Hey Noah, thanks for coming in for your trial session! We know the price gave you pause, so we wanted to offer you 20% off your first month if you sign up this week. Your skills would fit perfectly in our evening BJJ class. Want to chat about it? Reply to this email or call us! - Tom, ROAR MMA Sales', scheduled_for: `${today} 10:00:00` },
  { lead_id: 8, message_type: 'sms', status: 'pending', recipient_phone: '555-0208', body: 'Hey Sophie! Glad you loved the Muay Thai class with Sarah. We actually have a great community of women who train here, and our coaches are experts at scaling training to your comfort level. No pressure to spar! Want to come for another session this week? - ROAR MMA', scheduled_for: `${today} 14:00:00` },
...
const cancellations = [
  { member_id: 25, requested_by: adminUserId, cancellation_reason: 'Moving interstate for work', reason_category: 'relocation', status: 'pending' },
  { member_id: 24, requested_by: 24, cancellation_reason: 'Back injury making training difficult', reason_category: 'medical', status: 'pending' },
];
